#Assignment10:Read a color image and do contrast maniplulation of the image

import math
import numpy as np
import cv2
image = cv2.imread(r"C:\Users\Dell\Downloads\Chistiano ronaldo.jpg")                                  #Reading the image
m,n,v = image.shape
